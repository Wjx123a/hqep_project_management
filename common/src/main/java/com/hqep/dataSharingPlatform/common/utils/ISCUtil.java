...
public class ISCUtil {
    ...
    private static String ISC_SSO_URL="";// = "http://10.166.8.82:17001/isc_sso"; //统一认证服务地址
    private static String APP_ID ="8a2688d37d3089ba017d30fdf64a0005";//= "ff8080814d339ab7014d6a0a0b19114b"; //统一认证服务地址
    private static String ISC_FRONTMV_SERV_URL="";// = "http://10.166.8.84:17001/isc_frontmv_serv"; //接口地址9
    private static String JSON_PATH="";//项目资源路径地址
    public ISCUtil() {
        try {
            Properties properties = new Properties();
            properties.load(ISCUtil.class.getResourceAsStream("/isc/iscinfo.properties"));
...
//            ids.getUserOrgPathByUserId()
            String userId = ISCUtil.getISCUserInfoBean(request).getIscUserId();
    ...
    public static List<User> getUsersByLoginCode(HttpServletRequest request){
        ...
        try{
            //身份服务
            IIdentityService ids = AdapterFactory.getIdentityService();
            String loginCode =  ISCUtil.getISCUserInfoBean(request).getIscUserSourceId();
